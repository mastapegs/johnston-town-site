# Community Resource Directory Sites — Research Archive

_Research conducted March 2026 to inform the Johnston Community Directory roadmap._

> **Note:** This document is a research reference. For current project status, deliverables, and competitive benchmarks, see [growth-roadmap.md](./growth-roadmap.md).
...
| **SACRD (San Antonio)**              | City-level resource directory     | Single city (~1.4M pop.)                              | sacrd.org                   |
...
Every major community resource site leads with a prominent search bar. findhelp.org and 211 both open with a single input asking "What do you need help with?" or "Enter your ZIP code." Users who don't know which category to pick need a text-based fallback.
...
211 offers phone, text, chat, and web. findhelp.org has a mobile app. James City County lets residents pay bills and submit forms online. At minimum, a mobile-responsive site with a 211 referral covers the essentials.
...
211 covers 12+ top-level categories with deep subcategories. findhelp.org uses tags for granular filtering. For small-town directories, fewer well-populated categories are better than many empty ones.

---

## Full Feature Matrix (Point-in-Time Snapshot)

_Captured March 2026. For Johnston's current status, see the competitive benchmarks table in [growth-roadmap.md](./growth-roadmap.md)._

| Feature                        | findhelp | 211 | James City |       Windsor       | Sherborn | Sr. Resource MI | SACRD |
| ------------------------------ | :------: | :-: | :--------: | :-----------------: | :------: | :-------------: | :---: |
...
- [SACRD — San Antonio Community Resource Directory](https://www.sacrd.org/)
